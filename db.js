...
const songsByFolder = {
    ...
    'Upgraded Old Love': [
      {
        songTitle: "Hawa Hawa GenZ Version",
        songName: "Hawa Hawa - from Dhurandhar - The JINN",
        fileName: "songs/hawahawa.mp3",
        coverName: "song_banner/jinnnnn.webp",
        folder: "Upgraded Old Love"
      },
      {
        songTitle: "Ishq Jalakar - Kaarvan",
        songName: "Ishq Jalakar - Kaarvan - Dhurandhar",
        fileName: "songs/ishq_kaarvan.mp3",
        coverName: "song_banner/ishq_jalakar_karvan.jpg",
        folder: "Upgraded Old Love"
      },
      {
        songTitle: "Run down the city X Monika",
        songName: "Run down the city X Monika - Dhurandhar",
        fileName: "songs/run_down_city_monika.mp3",
        coverName: "song_banner/rundown_monika.jpg",
        folder: "Upgraded Old Love"
      },
    ],
    'Rebel': [
      {
        songTitle: "Dhurandhar Title track",
        songName: "Na de dil pardesi nu...",
        fileName: "songs/dhurandhar_title_track.mp3",
        coverName: "song_banner/dhurandhar_title.webp",
        folder: "Rebel"
      },
      {
        songTitle: "Fa9la Rebel entry",
        songName: "Fa9la Rebel entry song",
        fileName: "songs/fa9la_rahman_dakt.mp3",
        coverName: "song_banner/fa9la.webp",
        folder: "Rebel"
      }
    ]
  };

export default songsByFolder;